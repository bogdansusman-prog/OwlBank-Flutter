...
/// Mirrors Angular's `WithdrawDialog` (`withdraw-dialog.ts`/`.html`):
/// lets the user take money out of their balance by entering an amount
/// and a description, then calls `UserService.withdraw()`.
...
class _WithdrawDialogState extends State<WithdrawDialog> {
  ...
  Future<void> _withdraw() async {
    ...
    try {
      await _userService.withdraw(amount, description);
      ...
      setState(() {
        if (error.response?.statusCode == 401) {
          _errorMessage = 'Your session has expired. Please retry.';
        } else {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Withdraw money from your OwlBank account',
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        _isLoading ? 'Withdrawing...' : 'Withdraw',
                      ),
